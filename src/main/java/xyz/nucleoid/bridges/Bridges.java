...
public class Bridges implements ModInitializer {
    ...
    public void onInitialize() {
        BRIDGES_GOAL_BLOCK = Registry.register(Registries.BLOCK, new Identifier(ID, "goal_block"), new BridgesGoalBlock(FabricBlockSettings.of(Material.PORTAL).noCollision().strength(-1)));
    }
}
